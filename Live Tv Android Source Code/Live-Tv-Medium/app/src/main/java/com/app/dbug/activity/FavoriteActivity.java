...
public class FavoriteActivity extends AppCompatActivity {
    ...
    AdapterChannelList adapterFavorit;
    ...
    RelativeLayout mainLayoutFavActivi;
    boolean isDark;
    int nativeAdsCount;

    RelativeLayout mainLayoutAllFav;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainLayoutAllFav = findViewById(R.id.main_layout_all_fav);
        ...
        swiperefresh.setOnRefreshListener(() -> {
            ...
            mainLayoutFavActivi.setVisibility(View.GONE);
        ...
        fbNativeManager = new NativeAdsManager(FavoriteActivity.this, fbNativeAdId, 3);
        sharedPreferences = getSharedPreferences(SplashActivity.MYPREFERENCE, MODE_PRIVATE);
        ...
        mainLayoutFavActivi = findViewById(R.id.main_layout_fav_activi);
        ...
        if (sharedPreferences.getString(ADSKEY, "1").equals("1")) {
            ...
            com.unity3d.services.banners.BannerView topBanner = new com.unity3d.services.banners.BannerView(FavoriteActivity.this, adUnitId, new UnityBannerSize(320, 50));
    ...
    public void loadData() {
        ...
        if (channelList == null) {
            ...
            adapterFavorit = new AdapterChannelList(FavoriteActivity.this, modelBase);
            ...
            GridLayoutManager gridLayoutManager1 = new GridLayoutManager(FavoriteActivity.this, spanCout);

            gridLayoutManager1.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                @Override
                public int getSpanSize(int position) {
                    switch (adapterFavorit.getItemViewType(position)) {
                        case 1:
                            return spanCout;
                        case 0:
                            return 1;
            ...
            myListRv.setAdapter(adapterFavorit);
            swiperefresh.setRefreshing(false);

            shimmerViewContainer.setVisibility(View.GONE);
            shimmerViewContainer.stopShimmer();
            mainLayoutFavActivi.setVisibility(View.VISIBLE);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        new AnimIntent.Builder(FavoriteActivity.this).performSlideToRight();
