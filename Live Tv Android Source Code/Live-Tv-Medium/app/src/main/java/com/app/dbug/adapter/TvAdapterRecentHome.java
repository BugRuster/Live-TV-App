...
public class TvAdapterRecentHome extends RecyclerView.Adapter<TvAdapterRecentHome.ChannelView> implements InterAdClickInterFace{
    ...
    public TvAdapterRecentHome(Context context) {
        this.context = context;
    }

    public TvAdapterRecentHome(Context context , List<Channel.Datum> itemModelsList) {
        this.itemModelsList = itemModelsList;
        this.context = context;
        sessionAds =new SessionAds(context,this);
    ...
    public void onBindViewHolder(@NonNull ChannelView holder, int position) {
        ...
        Glide.with(holder.itemView)
                .load(Constant.ADMIN_PANEL_URL+ Constant.IMAGE_URL +channelItem.image)
