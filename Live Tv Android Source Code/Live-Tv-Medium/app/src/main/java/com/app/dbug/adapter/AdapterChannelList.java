...
public class AdapterChannelList extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements InterAdClickInterFace {
    ...
    public AdapterChannelList(Context context, List<Object> modelBase) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        switch (viewType) {
            ...
            default:
                ...
                if (spanCout == 1){
                    menuItemLayoutView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.channal_item_all_activity_glid, viewGroup, false);
                }else {
                    menuItemLayoutView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.channal_item_all_activity, viewGroup, false);
                }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder1, int position) {
        ...
        switch (viewType) {
            case 1:
                if (fbNative) {
                    UnifiedNativeAdViewHolder holder = (UnifiedNativeAdViewHolder) holder1;
                    ...
                    Glide.with(holder.itemView)
                            ...
                            .fitCenter()
                            .thumbnail(0.3f).placeholder(R.drawable.placeholder)
                            .into(holder.ad_icon);
...
//                }
                ...
                int spanCout = sharedPreferences.getInt("spanCout", 1);
...
//        CardView cardview;
        ...
        CircleImageView channelImageView1;
...
//            cardview = itemView.findViewById(R.id.cardview);
           ...
           int spanCout = sharedPreferences.getInt("spanCout", 1);
            if (spanCout == 3){
                channelImageView1 = itemView.findViewById(R.id.channelImageView);
            }else {
