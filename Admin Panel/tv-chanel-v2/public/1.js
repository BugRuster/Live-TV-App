...
var render = function() {
  ...
  return _c(
    ...
    [
        ...
        "b-button",
        {
          on: {
            click: function($event) {
              return _vm.$bvModal.show(_vm.item.id)
            }
          }
        },
        [_vm._v("View")]
      ...
      _c(
        "b-modal",
        { attrs: { id: _vm.item.id, size: _vm.size, title: _vm.item.name } },
        [
          _c(
            "div",
            [
              _c(
                ...
                [
                  _c("b-card-text", { staticClass: "slider-text" }, [
                    _vm._v(
                      "\n     message: " + _vm._s(_vm.item.message) + "\n    "
                    )
                  ])
                ],
                1
